...
//
//  Name:  String
//  Tests: Less than, greater than, less than or equal to, greater than or equal to
//
...
int main ()
{
    ...
    std::cout << "Done testing less than, greater than, and equal to variants." << std::endl;
}
